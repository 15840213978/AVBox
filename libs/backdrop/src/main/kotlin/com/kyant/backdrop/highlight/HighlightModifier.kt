...
internal class HighlightNode(
    ...
    private var recordedWidthValue = Float.NaN
    private var recordedBlurValue = Float.NaN
    ...
    override fun ContentDrawScope.draw() {
        ...
        if (highlightLayer != null) {
            ...
            if (outline !== recordedOutline ||
                highlight.width.value != recordedWidthValue ||
                highlight.blurRadius.value != recordedBlurValue ||
                highlight.style != recordedStyle
            ) {
                val safeSize =
                    IntSize(
                ...
                recordedWidthValue = highlight.width.value
                recordedBlurValue = highlight.blurRadius.value
